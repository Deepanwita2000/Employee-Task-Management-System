...
from .views import LoginAPIView, LogoutAPIView, RegisterAPIView, UserAPIView , register_view,dashboard_view,logout_view,user_profile,sample_login,choice_role,change_password,user_change_pass,activate,activate_otp,add_otp,RegisterManagerView,RegisterEmployeeView,ChangePasswordView
