...
from .views import (view_projects ,view_project_info,view_task_form,view_sample,view_employeeForm,assign_employee,my_task,progress,timeline_ai,view_tasks,view_employees,view_employees_update,
                    employee_progress_status,employee_complete_status,employee_pending_status,employee_list,view_team,domain_category)
...
urlpatterns = [
    ...
    # 
    path('employee_pending_status/<int:proj_id>/',employee_pending_status , name='employee_pending_status'),
    path('employee_complete_status/<int:proj_id>/',employee_complete_status , name='employee_complete_status'),
    path('employee_progress_status/<int:proj_id>/',employee_progress_status , name='employee_progress_status'),

    path('domain_category/',domain_category , name='domain_category'),
    # 
